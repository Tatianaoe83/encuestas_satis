...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Luego agregamos la nueva restricción del enum con todos los valores necesarios
    ...
    public function down(): void
    {
        ...
        DB::statement("ALTER TABLE envios MODIFY COLUMN estado ENUM('pendiente', 'enviado', 'respondido', 'cancelado') DEFAULT 'pendiente'");
    }
};
