            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg sm:rounded-lg">
                <div class="p-6 sm:p-8 text-gray-900">
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-6 sm:mb-8">
                        <h3 class="text-base sm:text-lg font-medium">Editar Cliente</h3>
                    ...
                    <form action="{{ route('clientes.update', $cliente) }}" method="POST" class="space-y-6 sm:space-y-8">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
                            <div>
                                ...
                                <x-text-input 
                                    ...
                                    :value="old('asesor_comercial', $cliente->asesor_comercial)" 
                                    required 
                                    autofocus 
