        ...
        <div class="w-full max-w-md">
                ...
                <div class="px-8 py-8">
                    ...
                    <form wire:submit="login" class="space-y-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="text-sm">
                                <a href="{{ route('password.request') }}" class="font-medium text-emerald-600 hover:text-emerald-500 transition-colors duration-200 hover:underline">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <button type="button" class="w-full inline-flex justify-center py-3 px-4 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 hover:border-gray-400 hover:text-gray-700 transition-all duration-200 transform hover:scale-105">
                        ...
                        <div class="text-center pt-4">
                            <p class="text-sm text-gray-600">
                                ...
                                <a href="{{ route('register') }}" class="font-semibold text-emerald-600 hover:text-emerald-500 transition-colors duration-200 hover:underline">
                                    Regístrate aquí
                                </a>
                            </p>
                        </div>
            ...
            <div class="text-center mt-6">
                <p class="text-xs text-gray-500">
                    © {{ date('Y') }} EncuestasPro. Todos los derechos reservados.
                </p>
            </div>
        </div>
    </div>
